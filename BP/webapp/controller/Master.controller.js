	...
	return BaseController.extend("ns.BP.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				PhoneNumber : function(oContext) {
					var iNumber = oContext.getProperty('PhoneNumber'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("PhoneNumber", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("PhoneNumber", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
