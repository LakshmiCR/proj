		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <PhoneNumber>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<PhoneNumber>", "<100 <CurrencyCode>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<PhoneNumber> Group");
				},
			...
			assertions : {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("PhoneNumber", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber : function () {
					return this.theListShouldBeSortedAscendingOnField("PhoneNumber");
				},
